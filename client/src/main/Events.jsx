...
const IssueRow = (props) => {
    ...
    <td>{props.row_value.latitude}</td>
    <td>{props.row_value.longitude}</td>
    <td>{props.row_value.location ? props.row_value.location.significance : ''}</td>
    ...
    render(){
        ...
        return(
            <div>
                ...
                </Panel>                <IssueTable issues_prop={this.state.events} deleteLandmark={this.deleteLandmark}/>
            </div>
        );
    }
}
